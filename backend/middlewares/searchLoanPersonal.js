...
// Recherche de livres réservés par un utilisateur avec filtre sur attributs du livre
const searchReservedBooksByUser = async (req, res) => {
    try {
...
module.exports = searchReservedBooksByUser;
