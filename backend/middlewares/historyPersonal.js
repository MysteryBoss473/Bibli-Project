...
// Fonction pour récupérer les livres empruntés ou rendus par un utilisateur
const getBorrowedAndReturnedBooksByUser = async (req, res) => {
    try {
        ...
        // Requête SQL avec les statuts 'emprunté' et 'rendu'
        let query = `
            SELECT 
                l.ISBN,
                l.Titre,
...
module.exports = getBorrowedAndReturnedBooksByUser;
